...
//判断是否为微信
    ...
    $.put_user2 = function (rs) {
        localStorage.qy_user2 = JSON.stringify(rs)
    }

    $.get_user2 = function (rs) {
        return rs ? JSON.parse(localStorage.qy_user2)[rs] : JSON.parse(localStorage.qy_user2)
    }

    $.put_user3 = function (rs) {
        localStorage.qy_user3 = JSON.stringify(rs)
    }

    $.get_user3 = function (rs) {
        return rs ? JSON.parse(localStorage.qy_user3)[rs] : JSON.parse(localStorage.qy_user3)
    }
